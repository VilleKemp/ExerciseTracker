...
#users controls
    ...
    def _exer_schema(self, edit=False):
        """
        Creates a schema dictionary for exercisess. If we're editing a exercise
        ...
        props["username"] = {
            "title": "Username",
            "description": "Username of the exercisee",
            "type": "string"
        }
        props["type"] = {
            "title": "Type",
            "description": "Used to specify the exercise done",
            "type": "string"
        }
        props["value"] = {
            "title": "Value",
            "description": "Used to specify ammount of exercise done",
            "type": "int"
        }
        props["valueunit"] = {
            "title": "Valueunit",
            "description": "Used to specify what unit of measurement value was",
            "type": "string"
        }
        props["date"] = {
            "title": "Date",
            "description": "Date used to specify when the exercise was done",
            "type": "string"
        }
        props["time"] = {
            "title": "Type",
            "description": "Time the exercise toke",
            "type": "int"
        }
        props["timeunit"] = {
            "title": "Timeunit",
            "description": "Used to specify the unit the given value was for instance (minutes)",
            "type": "string"
        }
        '''props[user_field] = {
